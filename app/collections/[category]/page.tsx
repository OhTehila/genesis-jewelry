...
const images: Record<string, string[]> = {
  rings: [
    "/jewelry/rings/ring1.png",
    "/jewelry/rings/ring (2).png",
    "/jewelry/rings/ring (3).png",
    "/jewelry/rings/ring (4).png",
    "/jewelry/rings/ring (5).png",
    "/jewelry/rings/ring (6).png",
    "/jewelry/rings/ring (7).png",
    "/jewelry/rings/ring (8).png",
    "/jewelry/rings/ring (9).png",
    "/jewelry/rings/ring (10).png",
  ],
  necklaces: [
    "/jewelry/necklaces/necklace1.png",
    "/jewelry/necklaces/necklace2.png",
    "/jewelry/necklaces/necklace3.png",
    "/jewelry/necklaces/necklace4.png",
    "/jewelry/necklaces/necklace5.png",
    "/jewelry/necklaces/necklace6.png",
  ],
  watches: [
    "/jewelry/watches/watch1.jpg",
    "/jewelry/watches/watch2.jpg",
    "/jewelry/watches/watch3.jpg",
    "/jewelry/watches/watch4.jpg",
    "/jewelry/watches/watch5.jpg",
    "/jewelry/watches/watch6.jpg",
     "/jewelry/watches/watch7.jpg",
    "/jewelry/watches/watch8.jpg",
    "/jewelry/watches/watch9.jpg",
    "/jewelry/watches/watch10.jpg",
    "/jewelry/watches/watch11.jpg",
  ],
  earrings: [
